...
export class AuthService {
    ...
    constructor(private routerService: RouterService, private httpClientService: HttpClientService) {}
    ...
    doLogin(usr: string, pwd: string, callBackSuccess?: (response: User) => void, callBackError?: (error: any) => void): void {
        const body = {
            username: usr,
            password: pwd,
        }
